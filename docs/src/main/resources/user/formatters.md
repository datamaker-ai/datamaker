...
Class: ca.breakpoints.datamaker.model.field.formatter.CamelCaseFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.CapitalizeFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.CreditCardFormatter
...
- Credit card format
    - Type: STRING
    - Default value: NONE
    - Possible values: SPACES, HYPHENS, NONE

### Date Time Numeric

Description:

Class: ca.breakpoints.datamaker.model.field.formatter.DateTimeNumericFormatter
...
- Timezone
    - Type: STRING
    - Default value: Long
    - Possible values: Integer, Long

### Date Time String

Description:

Class: ca.breakpoints.datamaker.model.field.formatter.DateTimeStringFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.DecimalFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.GeographyFormatter
...
- Format type
    - Type: STRING
    - Default value: NONE
    - Possible values: GEO_JSON, LAT_LONG, LATITUDE, LONGITUDE, AS_STRING, AS_DOUBLE, NONE
- Template
    - Type: STRING
    - Default value: {
      "type": "%s",
...
Class: ca.breakpoints.datamaker.model.field.formatter.IdentificationNumberFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.JsonFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.LowerCaseFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.NumberFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.PhoneFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.SnakeCaseFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.StringFormatter
...
Class: ca.breakpoints.datamaker.model.field.formatter.UpperCaseFormatter
