...
public final class MidiUtils {
	 ...
	 */
	public static void sendTuningChange(final Receiver recv, final int channel,
			final int tuningpreset) throws InvalidMidiDataException {
		// Data Entry
	...
	public static void sendTunings(final Receiver recv, final int bank,
		...
		final SysexMessage msg = MidiUtils.MidiTuningStandard
				.keyBasedTuningDump(MidiUtils.ALL_DEVICES, bank, preset, name,
						itunings);
		recv.send(msg, -1);
	}
	...
	public static final class GeneralMidiMessages {
		...
		private static SysexMessage setGeneralMidiMessage(
				final int targetDevice, final byte type) throws IOException,
		...
		public static SysexMessage gmSystemOff(final int targetDevice)
				throws IOException, InvalidMidiDataException {
			return setGeneralMidiMessage(targetDevice, GENERAL_MIDI_OFF);
		}

		public static SysexMessage gmSystemOn(final int targetDevice)
				throws IOException, InvalidMidiDataException {
			return setGeneralMidiMessage(targetDevice, GENERAL_MIDI_1_ON);
		}

		public static SysexMessage gm1SystemOn(final int targetDevice)
				throws IOException, InvalidMidiDataException {
			return setGeneralMidiMessage(targetDevice, GENERAL_MIDI_1_ON);
		}

		public static SysexMessage gm2SystemOn(final int targetDevice)
				throws IOException, InvalidMidiDataException {
	...
	public static final class DeviceControl {
		...
		private static SysexMessage setDeviceControl(final int targetDevice,
				final int control, final int value) throws IOException,
				InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
		...
		public static SysexMessage setMasterVolume(final int targetDevice,
				final int value) throws IOException, InvalidMidiDataException {
			return setDeviceControl(targetDevice, MASTER_VOLUME, value);
		}

		public static SysexMessage setMasterBalance(final int targetDevice,
				final int value) throws IOException, InvalidMidiDataException {
			return setDeviceControl(targetDevice, MASTER_BALANCE, value);
		}

		public static SysexMessage setMasterFineTuning(final int targetDevice,
				final int value) throws IOException, InvalidMidiDataException {
			return setDeviceControl(targetDevice, MASTER_FINE_TUNING, value);
		}

		public static SysexMessage setMasterCoarseTuning(
				final int targetDevice, final int value) throws IOException,
				InvalidMidiDataException {
			return setDeviceControl(targetDevice, MASTER_COARSE_TUNING, value);
		}

		public static SysexMessage setGlobalParameter(final int targetDevice,
				final int[] slotpath, final byte[] parameter, final int value)
				throws IOException, InvalidMidiDataException {
		...
		public static SysexMessage setGlobalParameter(final int targetDevice,
				final int[] slotpath, final byte[] parameter, final byte[] value)
				throws IOException, InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static final class ReverbEffect {
			...
			public static SysexMessage setReverbType(final int targetDevice,
					final int reverbType) throws IOException,
					InvalidMidiDataException {
				return setGlobalParameter(targetDevice, SLOTPATH_EFFECT_REVERB,
						REVERB_TYPE, reverbType);
			}

			public static SysexMessage setReverbTime(final int targetDevice,
					final int reverbTime) throws IOException,
					InvalidMidiDataException {
				return setGlobalParameter(targetDevice, SLOTPATH_EFFECT_REVERB,
		...
		public static final class ChorusEffect {
			...
			public static SysexMessage setChorusType(final int targetDevice,
					final int reverbType) throws IOException,
					InvalidMidiDataException {
			...
			public static SysexMessage setChorusModRate(final int targetDevice,
					final int reverbType) throws IOException,
					InvalidMidiDataException {
				return setGlobalParameter(targetDevice, SLOTPATH_EFFECT_CHORUS,
			...
			public static SysexMessage setChorusModDepth(
					final int targetDevice, final int reverbType)
					throws IOException, InvalidMidiDataException {
				return setGlobalParameter(targetDevice, SLOTPATH_EFFECT_CHORUS,
						CHORUS_MOD_DEPTH, reverbType);
			}

			public static SysexMessage setChorusFeedback(
					final int targetDevice, final int reverbType)
					throws IOException, InvalidMidiDataException {
				return setGlobalParameter(targetDevice, SLOTPATH_EFFECT_CHORUS,
			...
			public static SysexMessage setChorusSendToReverb(
					final int targetDevice, final int reverbType)
					throws IOException, InvalidMidiDataException {
				return setGlobalParameter(targetDevice, SLOTPATH_EFFECT_CHORUS,
	...
	public static final class KeyBasedInstrumentControl {
		...
		public static SysexMessage setKeyBasedControl(final int targetDevice,
				final int midi_channel, final int key_number,
				final int control, final int value) throws IOException,
				InvalidMidiDataException {
		...
		public static SysexMessage setKeyBasedControl(final int targetDevice,
				final int midi_channel, final int key_number,
				final int[] controls, final int[] values) throws IOException,
				InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
	...
	public static final class DestinationSettings {
		...
		public static SysexMessage setControllerDestinationForChannelPressure(
				final int targetDevice, final int channel,
				final int[] controls, final int[] ranges) throws IOException,
				InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage setControllerDestinationForControlChange(
				final int targetDevice, final int channel, final byte control,
				final int[] controls, final int[] ranges) throws IOException,
				InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
	...
	public static final class MidiTuningStandard {
		...
		public static SysexMessage scaleOctaveTuning1ByteForm(
				final int targetDevice, final boolean realtime,
				final boolean[] channels, final int[] tuning)
				throws IOException, InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			if (realtime) {
				baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
		...
		public static SysexMessage scaleOctaveTuning2ByteForm(
				final int targetDevice, final boolean realtime,
				final boolean[] channels, final int[] tuning)
				throws IOException, InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
		...
		public static SysexMessage scaleOctaveTuningDump1ByteForm(
				final int targetDevice, final int bank, final int preset,
				final String name, final int[] tuning) throws IOException,
				InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_NON_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage singleNoteTuningChange(
				final int targetDevice, final boolean realtime, final int bank,
				final int preset, final int[] key_numbers,
				final int[] key_tunings) throws IOException,
				InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			if (realtime) {
				baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
		...
		public static SysexMessage singleNoteTuningChange(
				final int targetDevice, final int preset,
				final int[] key_numbers, final int[] key_tunings)
				throws IOException, InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage keyBasedTuningDump(final int targetDevice,
				final int preset, final String name, final int[] tunings)
				throws IOException, InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_NON_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage keyBasedTuningDump(final int targetDevice,
				final int bank, final int preset, final String name,
				final int[] tunings) throws IOException,
				InvalidMidiDataException {
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_NON_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
