...
@NoArgsConstructor
@Indexed
@FieldType(description = "Big decimal number. Useful for money calculation.", localizationKey = "field.group.primitive.bigdecimal", group = FieldGroup.PRIMITIVE)
public class DecimalField extends Field<BigDecimal> {
    ...
    public DecimalField(String name, Locale locale) {
        super(name, locale);
    }

    @Override
    protected BigDecimal generateData() {
