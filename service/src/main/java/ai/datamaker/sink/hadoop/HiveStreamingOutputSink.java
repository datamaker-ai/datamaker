...
@Deprecated
public class HiveStreamingOutputSink implements DataOutputSink {

    // TODO support streaming

    private Partition partition;

    private static final Set<FormatType> ACCEPTED_FORMATS = Sets.newHashSet(FormatType.AVRO, FormatType.ORC, FormatType.PARQUET, FormatType.JSON);
