...
@Deprecated
public class AzureCosmosDbOutputSink implements DataOutputSink {
    // https://github.com/Azure-Samples/storage-table-java-getting-started/blob/master/src/main/java/com/microsoft/azure/cosmosdb/tablesample/TableBasics.java#L76
