...
class ParquetProcessorTest extends AbstractDatasetProcessorTest {

    protected ParquetProcessorTest() {
        super(new ParquetProcessor());
    }
    ...
    void process() {
        ...
        InputStream input = getClass().getClassLoader().getResourceAsStream("file-snappy.parquet");
    ...
    @Test
    void supportedTypes() {
        assertTrue(datasetProcessor.supportedTypes().contains(SupportedMediaType.PARQUET));
    }
}